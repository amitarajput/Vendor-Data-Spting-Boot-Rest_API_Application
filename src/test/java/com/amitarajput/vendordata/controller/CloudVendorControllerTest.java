...
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;// for get method
...
List<CloudVendor> cloudVendorList = new ArrayList<>();
    ...
    void setUp() {
        ...
        cloudVendorTwo = new CloudVendor("2","Walmart","USA","yyyy");
    ...
    void testCreateCloudVendorDetails() throws Exception{
        //converting object to the JSON
        ObjectMapper mapper = new ObjectMapper();
        mapper.configure(SerializationFeature.WRAP_ROOT_VALUE,false);
        ObjectWriter or = mapper.writer().withDefaultPrettyPrinter();
        String requestJson=or.writeValueAsString(cloudVendorOne);
